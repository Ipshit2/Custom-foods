...
function Navbar({ name } :NAME) {
  return (
    <div className='pt-[20px] pl-[20px] text-[20px] flex  text-[#E9E1D4] gap-x-[900px]'>
        <h1 className=' rounded-2xl w-[280px] px-[25px] py-[7px] border-[#201E1F] border-[4px] bg-[#423C3C]' >CustomFoods</h1>
